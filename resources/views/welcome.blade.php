        ...
        <nav class="nav container">
            ...
            @if (Route::has('login'))
                <nav class="-mx-3 flex flex-1 justify-end">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="rounded-md px-3 py-2 text-white">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="rounded-md px-3 py-2 text-white">Iniciar Sesión</a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="rounded-md px-3 py-2 text-white">Crear cuenta</a>
                        @endif
                    @endauth
                    <a href="{{ route('contactanos') }}" class="rounded-md px-3 py-2 text-white">Contactanos</a>
                </nav>
            @endif
        </nav>

        <section class="hero__container container">
            <label for="numero_paquete" class="hero__title">BIENVENIDO A RENTABIEN</label><br>
            <h3>Carrera 36 5B 60 Ofici. 210</h3>
            <h3>(2)5577474, 5142374, 3152139595</h3>
            <h3>rentabieninmobiliaria1@hotmail.com</h3>
        </section>
    </header>
    ...
    <main>
        <section class="container about">
            <div class="filter-container">
                ...
                <form action="{{ route('filtrar') }}" method="get" class="filter-form">
                ...
                @else
                    @foreach($properties as $property)
                        <div class="property-item">
                            ...
                            <b><a href="{{ route('propiedad.show', $property->id) }}" class="btn btn-info">Ver más...</a></b>
                        </div>
                    @endforeach
                @endif
            </section>            
